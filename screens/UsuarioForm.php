    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" name="nome" id="nome" class="form-control"
                value="<?php echo !empty($result->nome) ? $result->nome : "" ?>" required placeholder="Nome"><br>
        </div>
        <div class="form-group col-md-6">
            <label for="cpf">CPF</label>
            <input type="text" name="cpf" id="cpf" class="form-control"
                value="<?php echo !empty($result->cpf) ? $result->cpf : "" ?>" required
                placeholder="000.555.000-55"><br>
        </div>

        <div class="form-group col-md-2">
            <label for="telefone">Telefone</label>
            <input type="text" name="telefone" id="telefone" class="form-control"
                value="<?php echo !empty($result->telefone) ? $result->telefone : "" ?>" required
