...
? $result->nome : ""; ?>"><br>
        ...
        <input type="text" name="telefone" id="" value="<?php echo !empty($result->telefone)
? $result->telefone : ""; ?>" required><br>

        <label for="">CPF</label>
        <input type="text" name="cpf" id="" value="<?php echo !empty($result->cpf)
? $result->cpf : ""; ?>" required><br>
